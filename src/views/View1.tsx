...
const View1: React.FC<Props> = (props) => {
  ...
  return (
    <div>
      ...
      <button
        onClick={() => {
          props.confirmationOnClose(true);
        }}
      >
      ...
      <button
        onClick={() => {
          props.confirmationOnClose(false);
        }}
      >
      ...
      congue non ac. Vitae ultricies ex. Phasellus vel aliquet turpis. Praesent
      scelerisque viverra dignissim. Maecenas pretium sem et orci tincidunt, eu
      scelerisque felis ultrices. Integer sodales lacus ac mauris ullamcorper
      vulputate. Duis gravida urna in massa ornare convallis. Nunc posuere, erat
      et vehicula interdum, risus lectus varius dui, vitae accumsan dui neque
      vitae quam. Donec mattis nulla fringilla consectetur consequat. Praesent
      augue diam, facilisis et ante ac, accumsan fermentum sem. Curabitur semper
      et erat vitae feugiat. Nam sit amet nunc volutpat, dignissim est sit amet,
      placerat elit. Nulla sed lacus ultricies, faucibus purus in, malesuada
      lorem. Aliquam erat volutpat. Etiam velit odio, cursus vel tincidunt in,
      scelerisque vitae elit. Quisque consectetur justo tortor, ac fringilla dui
      venenatis eu. Curabitur lacinia leo ac tempor hendrerit. Cras eu nulla
      porta, maximus ex eu, condimentum nunc. Praesent quis commodo mi, a
      gravida turpis. Sed efficitur placerat odio, ut tincidunt nisi imperdiet
      id. Quisque lobortis at augue a blandit. Cras purus lacus, commodo ut
      pharetra ac, laoreet in orci. Cras quis scelerisque tortor. Nulla pulvinar
      at velit a gravida. Sed tristique consectetur tellus. Nullam molestie
      euismod nunc, eget molestie est condimentum eget.{' '}
